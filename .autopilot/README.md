...
- `<дата>-<проект>/` — папка одной сборки. Дата в имени — день, когда сборка началась,
  поэтому папки идут по порядку сверху вниз. Суффикс `` значит «ещё делается»;
...
|---|---|---|---|
| 2026-09-20 | `2026-09-20-matveyvoice-dictation` | сдан | Готовое приложение MatveyVoice для macOS: диктовка по горячей клавише в любое приложение, локальный Whisper (русский и английский), .dmg, README и лицензия MIT; живой прогон на реальных приложениях ещё не сделан |
